...
INDEX_PATH = r"vector_databases\index.faiss.index"  # Korrigierter Pfad mit Raw-String
DIMENSION = 768
...
def create_embedding_vector_db(chunks, db_name="faiss_index"):
    ...
    try:
        ...
        embedding = HuggingFaceEmbeddings(
            ...
            # Entferne model_kwargs, da keine GPU verwendet wird:
        ...
        # Speichere den Index
        index_path = os.path.join("vector_databases", f"{db_name}.index")
        print(f"Speichere Index in {index_path}")
        faiss.write_index(index, index_path)
        print(f"FAISS-Index wurde in vector_databases/{db_name}.index gespeichert.")
        return index
