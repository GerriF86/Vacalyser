...
st.markdown('<p class="about-title">About Vacalyser</p>', unsafe_allow_html=True)
st.markdown(
            """
            <p class="about-text">
            <b>Vacalyser</b> is a cutting-edge Streamlit web application designed to eliminate information loss in the crucial first steps of the hiring process. 
            ...
            <ul>
                ...
                <li><b>Actionable Insights:</b> Vacalyser transforms the collected data into a goldmine of information. Generate targeted job ads, pinpoint the best recruitment channels, and create comprehensive interview prep sheets – all from one centralized hub.</li>
            ...
            <p class="about-text">
            <b>Vacalyser</b> is more than just a data collection tool. It's your strategic partner in building a stronger, more successful workforce. We empower you to attract, identify, and hire top talent with confidence, setting the stage for long-term employee retention and organizational growth.
            </p>
            """,
